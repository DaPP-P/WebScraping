...
print("Loaded Pointsbet")

# Load Labrokes website
@timeout(300)
def load_ladbrokes_browser1():
    ladbrokes_browser1.get("https://www.ladbrokes.com.au/sports/basketball/usa")
    print("ladbrokes usa done")

@timeout(300)
def load_ladbrokes_browser3():
    ladbrokes_browser3.get("https://www.ladbrokes.com.au/sports/basketball/australia")
    print("ladbrokes australia done")

@timeout(300)
def load_ladbrokes_tennis():
    ladbrokes_tennis_browser.get("https://www.ladbrokes.com.au/sports/tennis")
    print("Loaded Ladbrokes")

try:
    load_ladbrokes_browser1()
except TimeoutError:
    print("ladbrokes usa did not load")
try:
    load_ladbrokes_browser3()
except TimeoutError:
    print("ladbrokes australia did not load")
try:
    load_ladbrokes_tennis()
except TimeoutError:
    print("loadbrokes tennis did not load")
...
# Once the program has been run i amount of times it must close the browsers.
    ...
    tab_browser.quit()
    tab_tennis_browser.quit()
    pointsbet_browser.quit()
    pointsbet_tennis_browser.quit()
    unibet_browser.quit()
    unibet_tennis_browser.quit()
    ladbrokes_browser1.quit()
    #ladbrokes_browser2.quit()
    ladbrokes_browser3.quit()
    ladbrokes_tennis_browser.quit()
